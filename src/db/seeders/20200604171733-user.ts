...
module.exports = {
	up: (queryInterface: QueryInterface, sequelize: Sequelize) => {
		return queryInterface.bulkInsert('Users', [
			...
			{ id: 2, firstname: 'Pablo', lastname: 'Aldonozo', email: 'paldonozo@email.com', dni: 21219635, birthdate: new Date('2000-05-11'), status: 2, createdAt: new Date(), updatedAt: new Date() },
			...
			{ id: 5, firstname: 'Gariel', lastname: 'Inoza', email: 'ginoza@email.com', dni: 11663077, birthdate: new Date('1977-03-04'), status: 0, createdAt: new Date(), updatedAt: new Date() },
		]);
	},
